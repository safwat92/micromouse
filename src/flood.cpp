...
//     if (to_center)
//     {
//         // خلايا السنتر الأربعة للمتاهة 16x16: (7,7), (7,8), (8,7), (8,8)
...
//                 // API::setText(next_x, next_y, to_string(maze[next_x][next_y]));
...
// // اختيار أفضل اتجاه للحركة بناءً على أقل مسافة
// int getNextMove()
// {
//     int min_maze = 1e9;
//     int best_dir = -1;
...
//     for (int d = 0; d < 4; d++)
//     {
//         // التحقق من عدم وجود جدار في هذا الاتجاه
...
//                 {
//                     // تفضيل السير في نفس الاتجاه لتجنب الدوران غير الضروري
//                     best_dir = d;
//                 }
//             }
//         }
...
// // // تدوير وتحريك الروبوت في المحاكي
